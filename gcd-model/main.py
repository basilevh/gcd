'''
Adapted from the SGM repository by Basile Van Hoorick for GCD, 2024.
'''
        ...
        if (
            ...
            if 'video_dict' in images:
                ...
                if 'extra' in video_dict:
                    scene_idx = video_dict['extra']['scene_idx'][0].item()
                ...
                for (k, v) in video_dict.items():
                    if torch.is_tensor(v):
                        ...
                        filename = (f'{k}_ep{pl_module.current_epoch:03d}'
                                    ...
                                    f'_si{scene_idx}_fr{fps}_mb{motion_bucket}'
                                    f'_az{azimuth:.1f}_el{elevation:.1f}_rd{radius:.1f}.mp4')
                        path = os.path.join(root, filename)
                        cv = convert_video(v)
